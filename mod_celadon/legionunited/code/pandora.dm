 ...
 * Босс=арена. Босс периодически спавнит разных мобов, убийство которых дамажит босса.
 * Мобы:
...
/mob/living/simple_animal/hostile/asteroid/elite/pandora/proc/blast_spam()
	if(stat != DEAD && blast_charges)
		blast_charges--
		var/list/turf/blast_turfs = spiral_range_turfs(10, src)
...
/obj/effect/temp_visual/hierophant/squares/preblast/Del()
