...
Модпак перерабатывает поведение и боевую стадию с Элитными мобами, делая их более динамичными.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/legionunited.dm`: `LEGIONUNITED_SPEED_MULTIPLIER`, `LEGIONUNITED_SPEED_BASE`
-->
