...
/datum/modpack/legionunited
	name = "Legion United"
	desc = "Изменение поведение Элитных Мобов"
	author = "ganza9991"
...
// Инициализация ДО
/datum/modpack/legionunited/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/legionunited/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/legionunited/post_initialize()
	. = ..()
