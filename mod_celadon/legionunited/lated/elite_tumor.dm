...
/obj/structure/elite_tumor/proc/make_fighter(mob/user)
	...
	RegisterSignal(user, list(COMSIG_PARENT_QDELETING, COMSIG_MOB_DEATH), PROC_REF(clear_fighter))
...
/obj/structure/elite_tumor/proc/clear_fighter(mob/source)
	...
	UnregisterSignal(source, list(COMSIG_PARENT_QDELETING, COMSIG_MOB_DEATH), COMSIG_PARENT_QDELETING)
